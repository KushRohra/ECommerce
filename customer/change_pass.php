...
<form action="" method="post">
	...
	<table align="center" width="600">
		<tr>
			...
			<td>
				<input type="password" name="current_pass" required style="margin: 10px;">			
			</td>
		</tr>
		<tr>
			<td align="right">
			...
			<td>
				<input style="margin: 10px;" type="password" required name="new_pass">		
			</td>
		</tr>
		<tr>
			<td align="right">
			...
			<td>
				<input type="password" style="margin: 10px;" required name="new_pass_again">			
			</td>
		</tr>
		<tr align="center">
			<td colspan="8">
