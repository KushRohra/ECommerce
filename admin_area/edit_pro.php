...
<body bgcolor="skyblue">
	<form action="" method="post" enctype="multipart/form-data">
		...
		<table align="center" width="800" height="600" border="2px solid black" bgcolor="cyan">
			<tr align="center">
				<td colspan="7"><h2>Edit Product Here:(you have to add an image otherwise it will not work)</h2></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="file" required name="product_image" ><img src="product_images/<?php echo $pro_image ?>" width="60" height="60"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><textarea name="product_desc" cols="50" rows="5"><?php echo $pro_desc ?></textarea></td>
			</tr>
			<tr>
				<td align="right"><b>Product Keywords: </b></td>
				<td><input value="<?php echo $pro_keyword ?>" size="50" type="text" name="product_keywords" ></td>
			</tr>
			<tr align="center">
